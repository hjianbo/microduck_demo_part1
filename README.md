...
The repository also contains a new transport-neutral foundation for the
Device Agent integration demo. See
[`src/device_agent_integration_demo/README.md`](src/device_agent_integration_demo/README.md)
for its behavior contract, local CLI, DeviceSpec draft, and acceptance steps.
